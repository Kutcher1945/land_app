...
amount_of_bins_1000m = st.number_input("Количество мусорных контейнеров в радиусе 1000м", min_value=0)
amount_of_poi_1000m = st.number_input("Количество точек интереса в радиусе 1000м", min_value=0)
amount_of_business19_1000m = st.number_input("Количество предприятий общественного питания в радиусе 1000м", min_value=0)
index_of_nearest_sensor_pm = st.number_input("Индекс ближайшего датчика после полудня", min_value=0)
index_of_nearest_sensor_am = st.number_input("Индекс ближайшего датчика до полудня", min_value=0)
